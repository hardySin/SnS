...
public class adminAddDta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminAddDta</title>");            
            out.println("</head>");
            out.println("<body>");
       ...
       String []values=request.getParameterValues("Dta_val");
            ...
            for (int i = 0; i < values.length; i++) {
                    ...
                    switch(i)
               {
                    ...
                    case 2: threobj.setTheater_date(values[i]);break;
                    case 3: threobj.setTheater_time(values[i]);break;
                  case 4: threobj.setTheater_plan(values[i]);break;
